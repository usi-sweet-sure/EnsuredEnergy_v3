...
public partial class ResourceManager : Node {
	...
	public void _StartGame(ref MoneyData money) {
		...
		EmitSignal(
			nameof(UpdateNextTurnStateEventHandler),
	...
	public void _UpdatePowerPlants(List<PowerPlant> lPP) {
		...
		foreach(PowerPlant pp in PowerPlants) {
			...
			if(!pp._GetEnergyConnectFlag()) {
				...
				//!!! trigger to be tested (should work) 02.07.2024
				pp.Connect(nameof(PowerPlant.UpdatePlantEventHandler), this, nameof(_OnBuildDone));
			}
		}
	}
	...
	public void _UpdateBuildButtons(List<BuildButton> lBB) {
		...
		foreach(BuildButton bb in BBs) {
			//!!! trigger to be tested (should work) 02.07.2024
			bb.Connect(nameof(BuildButton.BuildDoneEventHandler), this, nameof(_OnBuildDone));
		}
	} 
