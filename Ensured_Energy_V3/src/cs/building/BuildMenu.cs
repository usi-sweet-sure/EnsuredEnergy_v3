...
public partial class BuildMenu : CanvasLayer {
	...
	public override void _Ready() {
		...
		GasButton.Connect("pressed", this, nameof(_OnGasButtonPressed));
		SolarButton.Connect("pressed", this, nameof(_OnSolarButtonPressed));
		HydroButton.Connect("pressed", this, nameof(_OnHydroButtonPressed));
		TreeButton.Connect("pressed", this, nameof(_OnTreeButtonPressed));
		WindButton.Connect("pressed", this, nameof(_OnWindButtonPressed));
		WasteButton.Connect("pressed", this, nameof(_OnWasteButtonPressed)); 
		BiomassButton.Connect("pressed", this, nameof(_OnBiomassButtonPressed));
		RiverButton.Connect("pressed", this, nameof(_OnRiverButtonPressed));
		PumpButton.Connect("pressed", this, nameof(_OnPumpButtonPressed));
		CloseButton.Connect("pressed", this, nameof(_OnCloseButtonPressed));
	...
	public void _OnShowBuildMenu(BuildButton bb) {
		...
		if(IsOpen) {
            ...
            //!!! Same question as in buildbutton
			//!!! SelectBuilding -= RegisteredBuildButton._OnSelectBuilding;
            Disconnect(nameof(SelectBuildingEventHandler), this, nameof(RegisteredBuildButton._OnSelectBuilding));
		}
        ...
        Connect(nameof(SelectBuildingEventHandler), this, nameof(bb._OnSelectBuilding));
	...
	public void _OnGasButtonPressed() {
		...
		EmitSignal(nameof(SelectBuildingEventHandler), GasPlant);
	...
	public void _OnHydroButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), HydroPlant);
	...
	public void _OnSolarButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), SolarPlant);
	...
	public void _OnTreeButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), TreePlant);
	...
	public void _OnWindButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), WindPlant);
	...
	public void _OnWasteButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), WastePlant);
	...
	public void _OnBiomassButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), BiomassPlant);
	...
	public void _OnRiverButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), RiverPlant);
	...
	public void _OnPumpButtonPressed() {
		// Send out the selection
		EmitSignal(nameof(SelectBuildingEventHandler), PumpPlant);
